  ...
  return (
    <div className='bg-[#f3f3f3] flex justify-center px-4 py-6'>
        <motion.div 
            ...
            className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-6 py-4 flex justify-between items-center relative'>
            ...
            <div className='flex items-center gap-4 relative'>
                    ...
                    {showCreditPopup && (
                        <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
                            <p className='text-sm text-gray-600 mb-4'>
                                Need more credits? Purchase our premium plan to unlock unlimited AI-powered mock interviews, detailed performance analytics, and personalized feedback to ace your next interview!
                            </p>
                            <button
                ...
                <div className='relative'>
                    ...
                    className='w-9 h-9 bg-black text-white rounded-full flex items-center justify-center font-semibold'>
                        {userData ? userData.name[0] : <FaUserAstronaut size={16}/>}
                    </button>
                        {showUserPopup && (
