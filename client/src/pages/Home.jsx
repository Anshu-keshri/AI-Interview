      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='text-center mb-28'>
          ...
          className='text-gray-500 mt-6 max-w-2xl mx-auto text-lg'>
            Role-based mock interviews with smart follow-ups, adaptive difficulty and rela-time performance evaluation.
          </motion.p>
              ...
              [
                {
                  ...
                  desc: "AI adjustment difficulty based on Selected job role."
                },
                {
                  icon: <BsMic size={24}/>,
                  step: "STEP-2",
                  title: "AI-Powered Voice Interview",
                  desc: "Dynamic follow-up questions based on your answers, simulating real interview scenarios."
                },
                {
                ...
                className={`
                  relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all duraton-300
                  ${index === 0 ? "rotate-[-4deg]" : ""}
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc: "Project-specific interviews based on your resume, with tailored questions and feedback."
                },
                {
                  image: pdfImg,
                  icon: <BsFileEarmarkText size={20}/>,
                ...
                className='bg-white rounded-3xl border border-gray-200 shadow-sm hover:shadow-xl transition-all'>
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                transition={{duration: 0.5 + index * 0.1 }}
                whileHover={{y: -6}}
                className='bg-white rounded-3xl border border-gray-200 shadow-sm hover:shadow-xl transition-all p-6 md:p-8 min-h-[120px]'>
                  ...
                  <div className='flex items-center justify-between gap-6'>
                    ...
                    <div className='w-28 h-28 flex-shrink-0 flex items-center justify-center'>
                      <img src={mode.image} alt={mode.title} className='w-full h-full object-contain'/>
                    </div>
                  </div>
                </motion.div>
              ))
